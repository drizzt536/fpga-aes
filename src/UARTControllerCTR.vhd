...
architecture UARTControllerCTR_arch of UARTControllerCTR is
	...
	signal oblk           : AESBlock;
	signal keystream      : AESBlock;
begin
	ff0: process (clk)
	...
	-- NOTE: this is basically just oblk = AddRoundKey(iblk, keystream)
	out0: for i in 0 to 15 generate
